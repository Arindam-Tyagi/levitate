...
      updateDataset(activeDataset._id, cleanedDataset);
...
            <Button onClick={handleRemoveDuplicates} disabled={isProcessing} variant="primary" className="w-full">
              {isProcessing ? <RefreshCw className="h-4 w-4 mr-2 animate-spin" /> : <Trash2 className="h-4 w-4 mr-2" />}
              Remove Duplicates
            </Button>
            <Button onClick={() => handleMissingValuesAction('fill')} disabled={isProcessing} variant="secondary" className="w-full">
              Fill Missing Values
            </Button>
            <Button onClick={() => handleMissingValuesAction('remove')} disabled={isProcessing} variant="danger" className="w-full">
...
      {/* Data Preview */}
      <Card title="Data Preview" subtitle="A preview of the first 50 rows of your dataset">
